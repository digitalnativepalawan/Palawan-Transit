...
import { 
  ...
  Clock, MapPin, Phone, Mail, FileText, Trash2, Menu, Edit2
} from 'lucide-react';
      ...
      <div className="p-8 bg-gold/5 border border-gold/20 flex items-start gap-4">
        ...
        <div>
          ...
          <p className="text-[11px] text-muted leading-relaxed">
            ...
            Ensure your contact details are accurate to receive booking notifications and coordinate with passengers.
          </p>
        </div>
      </div>
    </div>
