          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="fixed inset-0 z-[100] flex justify-end">
            ...
            >
              ...
              <div className="space-y-8">
                <button onClick={() => setIsMenuOpen(false)} className="block text-4xl text-white italic hover:text-gold transition-colors text-left w-full">HOME</button>
                <button onClick={() => setIsMenuOpen(false)} className="block text-4xl text-white italic hover:text-gold transition-colors text-left w-full">ROUTES</button>
                ...
                <button onClick={() => { setIsMenuOpen(false); onAdminClick('Operator Login'); }} className="block text-4xl text-white italic hover:text-gold transition-colors text-left w-full">OPERATOR LOGIN</button>
                <button onClick={() => setIsMenuOpen(false)} className="block text-4xl text-white italic hover:text-gold transition-colors text-left w-full">HELP & CONTACT</button>
                <div className="pt-8 border-t border-border">
                  <button onClick={() => { setIsMenuOpen(false); onAdminClick('Admin Access'); }} className="flex items-center gap-3 text-gold ui-label tracking-[0.2em]">
                    <Shield size={16} />
                    ADMIN PORTAL
                  </button>
                </div>
